...
// Create a custom
// versions of the
// so that we're able to distinguish between a plaintext password not being
...
func ValidateUser(v *validator.Validator, user *User) {
	...
	// codebase (probably because we forgot to set a password for the user). It's a // useful sanity check to include here, but it's not a problem with the data
...
// when updating a movie. And we also check for a violation of the "users_email_key" // constraint when performing the update, just like we did when inserting the user
// record originally.
